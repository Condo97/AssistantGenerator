...
@FunctionCall(name = "Generate_Assistant_Spec", functionDescription = "Creates an assistant webpage per the spec.")
public class GenerateAssistantWebpageFC_Backup_V1 {
    ...
    public GenerateAssistantWebpageFC_Backup_V1() {
